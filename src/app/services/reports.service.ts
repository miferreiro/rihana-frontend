...
import {ReportInfo} from "./entities/ReportInfo";
...
export class ReportsService {
	...
	private mapReportInfo(reportInfo: ReportInfo): Report {
		return {
			...
			bed: reportInfo.bed,
			requestedExplorations: reportInfo.requestedExplorations,
			clinicalData: reportInfo.clinicalData,
			performedExplorations: reportInfo.performedExplorations,
			findings: reportInfo.findings,
